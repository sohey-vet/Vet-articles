...
## 🎯 結論
猫の下部尿路症状（頻尿・血尿・不適切排泄）の最大原因は **特発性膀胱炎（FIC）** であり、細菌感染ではない。若齢〜中齢猫の60〜75%がFICに分類される。 抗菌薬は無菌性のFICには無効であり、 **環境エンリッチメント（MEMO: Multimodal Environmental Modification）が治療の根幹** を成す。 **完全ウェットフード（水分含有量70%以上）への変更** により尿比重が低下し、再発率が有意に低下する。 急性期の疼痛管理には **ブプレノルフィンやガバペンチン** を使用し、NSAIDsの有効性は示されていない。
...
## 🗣️ 飼い主への説明ガイド
**Q. 「膀胱炎なのに抗生物質は使わないのですか？」**
猫ちゃんの膀胱炎の多くは、細菌が原因ではない「特発性膀胱炎」というタイプです。ストレスや生活環境が大きく関わっていて、抗生物質では改善しません。むしろ不要な抗生物質は腸内環境を乱すリスクがあります。今一番大切なのは、トイレ環境やお部屋の環境を猫ちゃんにとって快適に整えてあげることです。

**Q. 「また再発するのでしょうか？」**
正直にお伝えすると、環境改善を行わない場合は1年以内に約半数が再発します。ただし、トイレの数を増やす、ウェットフードに変える、遊びの時間を確保するなどの環境改善を続けることで、再発リスクをかなり下げることができます。一度にすべてを変える必要はありませんので、できることから始めていきましょう。

## 📚 参照論文
1. Buffington CAT. Idiopathic Cystitis in Domestic Cats ─ Beyond the Lower Urinary Tract. JVIM, 2011.
2. Westropp JL, et al. Evaluation of the effects of stress in cats with idiopathic cystitis. Am J Vet Res, 2006.
3. Buffington CAT, et al. Clinical evaluation of multimodal environmental modification (MEMO) in the management of cats with idiopathic cystitis. JFMS, 2006.
4. Kruger JM, et al. Feline Lower Urinary Tract Disease. In: Ettinger SJ, Feldman EC, eds. Textbook of Veterinary Internal Medicine, 8th ed. Elsevier, 2017.
5. Dorsch R, et al. Feline lower urinary tract disease in a German cat population ─ A retrospective analysis of demographic data, causes and clinical signs. Tierarztl Prax Ausg K Kleintiere Heimtiere, 2014.
